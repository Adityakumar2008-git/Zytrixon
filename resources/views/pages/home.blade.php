...
<x-layouts.app
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section id="hero-section" class="reveal relative overflow-hidden bg-white border-b border-neutral-200/80 min-h-[640px] lg:min-h-[780px] xl:min-h-[840px] flex items-center">
        ...
        <div class="relative z-10 mx-auto w-full max-w-[1400px] px-6 lg:px-12 py-16 lg:py-24">
            <div class="max-w-2xl lg:max-w-[56%]">
                ...
                <h1 class="mt-6 text-4xl sm:text-6xl lg:text-[74px] xl:text-[88px] font-black tracking-tight leading-[0.96] text-neutral-950 uppercase">
                    ...
                    <span class="reveal-line-wrap">
                        <span class="text-neutral-950 font-black reveal-line reveal-line-delay-2">Dominance.</span>
                    </span>
                </h1>

                {{-- Subtitle / Mission Statement --}}
                <p class="reveal-fade-up mt-6 max-w-lg text-base sm:text-lg text-neutral-600 leading-relaxed font-normal">
                ...
                <div class="reveal-fade-up mt-10 flex flex-wrap items-center gap-6">
                    <a href="/contact"
                       class="btn-magnetic btn-magnetic-primary inline-flex items-center gap-3 rounded-full bg-[#0F1012] px-8 py-4 text-sm font-semibold text-white shadow-xl transition-all duration-200 hover:bg-black hover:shadow-2xl active:scale-[0.97]">
                    ...
                    <a href="/work"
                       class="btn-magnetic inline-flex items-center gap-2 text-sm sm:text-base font-semibold text-neutral-800 transition-colors duration-200 hover:text-neutral-950 py-3 group">
                ...
                <div class="mt-12 lg:mt-16 flex items-center gap-3 font-mono text-xs text-neutral-500 uppercase tracking-widest">
                    <span class="font-bold text-neutral-900">01</span>
                    <span>/</span>
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section class="marquee-wrap border-y border-neutral-200/80 bg-neutral-950 text-white py-4 sm:py-5 select-none" aria-hidden="true">
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section class="reveal border-b border-neutral-200/80 bg-white py-20 px-6 lg:px-12 lg:py-28" id="about">
        <div class="mx-auto max-w-[1400px]">
            {{-- Top label row --}}
            ...
            <div class="mt-12 grid gap-16 lg:grid-cols-12 items-start">
                ...
                <div class="lg:col-span-7">
                    <h2 class="text-3xl sm:text-5xl lg:text-[60px] font-black tracking-tight text-neutral-950 leading-[1.02] uppercase">
                        ...
                        <span class="reveal-line-wrap"><span class="reveal-line reveal-line-delay-2 text-neutral-400">We solve business</span></span>
                        <span class="reveal-line-wrap"><span class="reveal-line reveal-line-delay-3">problems.</span></span>
                    </h2>

                    <p class="reveal-fade-up mt-8 max-w-xl text-base sm:text-lg text-neutral-600 leading-relaxed font-normal">
                    ...
                    <div class="reveal-fade-up mt-10">
                        <a href="/about" class="btn-magnetic group inline-flex items-center gap-3 text-sm font-semibold text-neutral-900 hover:text-neutral-600">
                            <span class="flex h-11 w-11 items-center justify-center rounded-full border border-neutral-300 text-neutral-900 transition-colors group-hover:border-neutral-900 group-hover:bg-neutral-900 group-hover:text-white">
                ...
                <div class="lg:col-span-5 space-y-6">
                    <div class="border-t border-neutral-200/80 pt-6 flex items-baseline justify-between">
                        <div>
                            <span class="font-mono text-xs uppercase tracking-widest text-neutral-400 block">01 / CLIENT COMMITMENT</span>
                            <p class="text-sm text-neutral-600 mt-1">Satisfaction rate across all delivered systems</p>
                        </div>
                        <span class="text-4xl sm:text-5xl font-black tracking-tight text-neutral-900 font-mono">100%</span>
                    </div>

                    <div class="border-t border-neutral-200/80 pt-6 flex items-baseline justify-between">
                        <div>
                            <span class="font-mono text-xs uppercase tracking-widest text-neutral-400 block">02 / PROVEN TRACK RECORD</span>
                            <p class="text-sm text-neutral-600 mt-1">Production solutions engineered & deployed</p>
                        </div>
                        <span class="text-4xl sm:text-5xl font-black tracking-tight text-neutral-900 font-mono">15+</span>
                    </div>

                    <div class="border-t border-neutral-200/80 pt-6 flex items-baseline justify-between">
                        <div>
                            <span class="font-mono text-xs uppercase tracking-widest text-neutral-400 block">03 / GLOBAL REACH</span>
                            <p class="text-sm text-neutral-600 mt-1">Cross-border market presence & clients</p>
                        </div>
                        <span class="text-4xl sm:text-5xl font-black tracking-tight text-neutral-900 font-mono">5+</span>
                    </div>

                    <div class="border-t border-neutral-200/80 pt-6 flex items-baseline justify-between">
                        <div>
                            <span class="font-mono text-xs uppercase tracking-widest text-neutral-400 block">04 / TIMELINE PRECISION</span>
                            <p class="text-sm text-neutral-600 mt-1">Milestone on-time delivery metric</p>
                        </div>
                        <span class="text-4xl sm:text-5xl font-black tracking-tight text-neutral-900 font-mono">98%</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section class="py-12 sm:py-20 overflow-hidden bg-[#FAFAFA] border-b border-neutral-200/80 select-none">
        <div class="mx-auto max-w-[1400px] px-6 lg:px-12">
            <p class="text-architectural text-neutral-200 font-black tracking-tighter leading-none whitespace-nowrap overflow-hidden">
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section class="reveal border-b border-neutral-200/80 bg-white py-20 px-6 lg:px-12 lg:py-28" id="services">
        <div class="mx-auto max-w-[1400px]">
            {{-- Header line --}}
            <div class="flex items-center justify-between border-b border-neutral-200/80 pb-4">
            ...
            <div id="services-split-showcase" class="mt-12 grid gap-12 lg:grid-cols-12 items-start">
                ...
                <div class="lg:col-span-7 divide-y divide-neutral-200/80 border-t border-neutral-200/80">
                    ...
                    <div class="service-split-row py-6 cursor-pointer group" data-service-index="0" data-service-tag="Next.js / React / Laravel">
                        <div class="flex items-center justify-between">
                            <div class="flex items-baseline gap-6">
                                <span class="font-mono text-xs text-neutral-400 group-hover:text-neutral-900 transition-colors">01</span>
                                <h3 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 group-hover:text-black transition-colors">
                                    Web Development
                                </h3>
                            </div>
                            <span class="service-arrow text-neutral-400 group-hover:text-neutral-900 text-xl font-mono">&rarr;</span>
                        </div>
                        <p class="mt-2 text-sm text-neutral-600 pl-10 max-w-xl">
                    ...
                    <div class="service-split-row py-6 cursor-pointer group" data-service-index="1" data-service-tag="React Native / Flutter / iOS / Android">
                        <div class="flex items-center justify-between">
                            <div class="flex items-baseline gap-6">
                                <span class="font-mono text-xs text-neutral-400 group-hover:text-neutral-900 transition-colors">02</span>
                                <h3 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 group-hover:text-black transition-colors">
                    ...
                    <div class="service-split-row py-6 cursor-pointer group" data-service-index="2" data-service-tag="Sensors / MQTT / Real-Time Telemetry">
                        <div class="flex items-center justify-between">
                            <div class="flex items-baseline gap-6">
                                <span class="font-mono text-xs text-neutral-400 group-hover:text-neutral-900 transition-colors">03</span>
                                <h3 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 group-hover:text-black transition-colors">
                                    IoT Solutions
                                </h3>
                            </div>
                    ...
                    <div class="service-split-row py-6 cursor-pointer group" data-service-index="3" data-service-tag="LLM Orchestration / Workflows / Analytics">
                        <div class="flex items-center justify-between">
                            <div class="flex items-baseline gap-6">
                                <span class="font-mono text-xs text-neutral-400 group-hover:text-neutral-900 transition-colors">04</span>
                                <h3 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 group-hover:text-black transition-colors">
                                    AI & Automation
                                </h3>
                            </div>
                    ...
                    <div class="service-split-row py-6 cursor-pointer group" data-service-index="4" data-service-tag="Enterprise ERP / CRM / Cloud Architecture">
                        <div class="flex items-center justify-between">
                            <div class="flex items-baseline gap-6">
                                <span class="font-mono text-xs text-neutral-400 group-hover:text-neutral-900 transition-colors">05</span>
                                <h3 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 group-hover:text-black transition-colors">
                                    Custom Software
                                </h3>
                            </div>
                    ...
                    <div class="service-split-row py-6 cursor-pointer group" data-service-index="5" data-service-tag="Technical SEO / PPC / Conversion Growth">
                        <div class="flex items-center justify-between">
                            <div class="flex items-baseline gap-6">
                                <span class="font-mono text-xs text-neutral-400 group-hover:text-neutral-900 transition-colors">06</span>
                                <h3 class="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 group-hover:text-black transition-colors">
                                    Digital Marketing
                                </h3>
                            </div>
                ...
                <div class="hidden lg:block lg:col-span-5 sticky top-28">
                    <div class="relative aspect-[4/3] rounded-3xl overflow-hidden bg-neutral-950 border border-neutral-200/80 shadow-2xl">
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section class="reveal py-16 px-4 sm:px-6 lg:px-8 bg-white" id="work">
        <div class="mx-auto max-w-[1400px]">
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section class="border-b border-neutral-200/80 bg-white py-20 px-6 lg:px-12 lg:py-28" id="process">
        <div class="mx-auto max-w-[1400px]">
            <div class="flex items-center justify-between border-b border-neutral-200/80 pb-4">
            ...
            <div id="process-timeline" class="mt-12">
                {{-- Progress Bar --}}
                <div class="w-full bg-neutral-200 h-0.5 relative overflow-hidden mb-10">
                    <div class="process-progress-line bg-neutral-900 h-full w-[16.6%]"></div>
                </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
                    ...
                    <div class="process-step-trigger is-active border-t-2 border-transparent pt-4" data-step="0">
                        ...
                        <h4 class="font-bold text-base text-neutral-900 mt-1">Discovery</h4>
                        <p class="text-xs text-neutral-500 mt-1">Workshops & research</p>
                    </div>
                    ...
                    <div class="process-step-trigger border-t-2 border-transparent pt-4" data-step="1">
                        ...
                        <h4 class="font-bold text-base text-neutral-900 mt-1">Design</h4>
                        <p class="text-xs text-neutral-500 mt-1">Prototypes & UX</p>
                    </div>
                    ...
                    <div class="process-step-trigger border-t-2 border-transparent pt-4" data-step="2">
                        ...
                        <h4 class="font-bold text-base text-neutral-900 mt-1">Architecture</h4>
                        <p class="text-xs text-neutral-500 mt-1">Schemas & stacks</p>
                    </div>
                    ...
                    <div class="process-step-trigger border-t-2 border-transparent pt-4" data-step="3">
                        ...
                        <h4 class="font-bold text-base text-neutral-900 mt-1">Develop</h4>
                        <p class="text-xs text-neutral-500 mt-1">Agile sprints</p>
                    </div>
                    ...
                    <div class="process-step-trigger border-t-2 border-transparent pt-4" data-step="4">
                        ...
                        <h4 class="font-bold text-base text-neutral-900 mt-1">QA</h4>
                        <p class="text-xs text-neutral-500 mt-1">Testing & auditing</p>
                    </div>
                    ...
                    <div class="process-step-trigger border-t-2 border-transparent pt-4" data-step="5">
                        ...
                        <h4 class="font-bold text-base text-neutral-900 mt-1">Deploy</h4>
                        <p class="text-xs text-neutral-500 mt-1">Release & scale</p>
                    </div>
                </div>

                {{-- Detail Panes --}}
                <div class="mt-10 p-8 rounded-3xl bg-[#F7F7F8] border border-neutral-200/80">
                    <div class="process-detail-panel is-active" data-step="0">
                        <h5 class="text-xl font-bold text-neutral-900">01 — Discovery & Requirements Alignment</h5>
                        <p class="text-sm sm:text-base text-neutral-600 mt-2 max-w-2xl leading-relaxed">
                    ...
                    <div class="process-detail-panel hidden" data-step="1">
                        <h5 class="text-xl font-bold text-neutral-900">02 — User Interface & System Experience Design</h5>
                        <p class="text-sm sm:text-base text-neutral-600 mt-2 max-w-2xl leading-relaxed">
                    ...
                    <div class="process-detail-panel hidden" data-step="2">
                        <h5 class="text-xl font-bold text-neutral-900">03 — Robust Engineering Architecture</h5>
                        <p class="text-sm sm:text-base text-neutral-600 mt-2 max-w-2xl leading-relaxed">
                    ...
                    <div class="process-detail-panel hidden" data-step="3">
                        <h5 class="text-xl font-bold text-neutral-900">04 — Full-Stack Agile Development</h5>
                        <p class="text-sm sm:text-base text-neutral-600 mt-2 max-w-2xl leading-relaxed">
                    ...
                    <div class="process-detail-panel hidden" data-step="4">
                        <h5 class="text-xl font-bold text-neutral-900">05 — Rigorous Quality Assurance & Security</h5>
                        <p class="text-sm sm:text-base text-neutral-600 mt-2 max-w-2xl leading-relaxed">
                    ...
                    <div class="process-detail-panel hidden" data-step="5">
                        <h5 class="text-xl font-bold text-neutral-900">06 — Zero-Downtime Deployment & Scaled Monitoring</h5>
                        <p class="text-sm sm:text-base text-neutral-600 mt-2 max-w-2xl leading-relaxed">
    ...
    {{-- ============================================================
         ...
         ============================================================ --}}
    <section class="py-12 px-4 sm:px-6 lg:px-8 bg-white" id="testimonials">
        <div class="mx-auto max-w-[1400px]">
    ...
    <section class="border-b border-neutral-200/80 bg-white py-20 px-6 lg:px-12 lg:py-28" id="insights">
        <div class="mx-auto max-w-[1400px]">
            ...
            <div class="mt-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <h2 class="text-3xl sm:text-4xl font-black tracking-tight text-neutral-900 uppercase">
                    Ideas, strategies and<br>engineering perspectives.
                </h2>
                <a href="/about" class="inline-flex items-center gap-2 text-sm font-semibold text-neutral-900 hover:text-neutral-600">
            ...
            <div class="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <article class="reveal hover-lift group flex flex-col justify-between rounded-3xl frosted-glass-card p-5">
                    ...
                    <div class="mt-4 px-1 flex items-center justify-between text-xs text-neutral-500 font-mono pt-3 border-t border-neutral-100">
