...
<x-layouts.app
    ...
    <section class="py-8 px-4 sm:px-6 lg:px-8 bg-neutral-100">
        <div class="mx-auto max-w-[1400px] overflow-hidden rounded-3xl border border-neutral-200/80 shadow-md">
        ...
        <div class="grid gap-12 lg:grid-cols-2">
            ...
            <div class="space-y-4">
                @foreach ($values as $val)
                    <div class="rounded-2xl border border-neutral-200/80 bg-white p-6 shadow-xs transition-all hover:shadow-md hover:border-neutral-300">
                        <h3 class="text-base font-bold text-neutral-900">{{ $val['title'] }}</h3>
                        <p class="mt-2 text-sm leading-relaxed text-neutral-600">{{ $val['description'] }}</p>
                    </div>
                @endforeach
            </div>
        </div>
    ...
    <x-section id="team" class="bg-[#F7F7F8]">
        <div>
    ...
    <x-section id="presence">
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-3xl border border-neutral-200/80 bg-white p-8 text-center shadow-xs">
                <span class="font-mono text-4xl font-bold text-neutral-900">60%</span>
                <p class="mt-3 text-xs font-mono uppercase tracking-wider text-neutral-400">International Clients</p>
                <p class="mt-1 text-xs text-neutral-600">USA, UK & UAE primary markets</p>
            </div>

            <div class="rounded-3xl border border-neutral-200/80 bg-white p-8 text-center shadow-xs">
                <span class="font-mono text-4xl font-bold text-neutral-900">100%</span>
                <p class="mt-3 text-xs font-mono uppercase tracking-wider text-neutral-400">In-House Talent</p>
                <p class="mt-1 text-xs text-neutral-600">Zero third-party outsourcing</p>
            </div>

            <div class="rounded-3xl border border-neutral-200/80 bg-white p-8 text-center shadow-xs">
                <span class="font-mono text-4xl font-bold text-neutral-900">2h</span>
                <p class="mt-3 text-xs font-mono uppercase tracking-wider text-neutral-400">Response Target</p>
                <p class="mt-1 text-xs text-neutral-600">Fast enquiry turnaround</p>
            </div>

            <div class="rounded-3xl border border-neutral-200/80 bg-white p-8 text-center shadow-xs">
                <span class="font-mono text-4xl font-bold text-neutral-900">30d</span>
                <p class="mt-3 text-xs font-mono uppercase tracking-wider text-neutral-400">Free Support</p>
                <p class="mt-1 text-xs text-neutral-600">Post-launch bug-fix window</p>
            </div>
        </div>
    </x-section>
    ...
    @if (!empty($careers))
        <x-section id="careers" class="bg-[#F7F7F8]">
            <div>
